    ...
    for(j = 0; j < byBufNum; j++)
    {
        ...
        switch(rcv_step) {
            ...
            case 1:    //Put the transmitting machin id after checking the data
                ...
                {
                    //ROS_INFO("1.data %d", data);
                    byChkSum += data;
                    //ROS_INFO("1. %d", byChkSum);
                    serial_comm_rcv_buff[byPacketNum++] = data;
            ...
            case 2:    //Check ID
                ...
                {
                    //ROS_INFO("2.data %d", data);
                    byChkSum += data;
                    //ROS_INFO("2. %d", byChkSum);
                    serial_comm_rcv_buff[byPacketNum++] = data;
             ...
             case 3:    //Put the PID number into the array
                //ROS_INFO("3.data %d", data);
                byChkSum += data;
                //ROS_INFO("3. %d", byChkSum);
                serial_comm_rcv_buff[byPacketNum++] = data;
             ...
             case 4:    //Put the DATANUM into the array
                //ROS_INFO("4.data %d", data);
                byChkSum += data;
                //ROS_INFO("4. %d", byChkSum);
                serial_comm_rcv_buff[byPacketNum++] = data;
             ...
             case 5:    //Put the DATA into the array
                //ROS_INFO("5.data %d", data);
                byChkSum += data;
                //ROS_INFO("5. %d", byChkSum);
                serial_comm_rcv_buff[byPacketNum++] = data;
             ...
             case 6:    //Put the check sum after Checking checksum
                //ROS_INFO("6.data %d", data);
                byChkSum += data;
                serial_comm_rcv_buff[byPacketNum++] = data;
                //ROS_INFO("6. %d", byChkSum);
                if(byChkSum == 0)
                {
                    //ROS_INFO_STREAM("Pub");
